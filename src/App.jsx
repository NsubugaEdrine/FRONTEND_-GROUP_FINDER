...
import { LayoutDashboard, Users, User, LogOut, LogIn, UserPlus } from 'lucide-react';
...
const Navbar = () => {
    ...
    return (
        <nav className="navbar">
            <Link to="/" className="nav-brand">StudyGroup Finder</Link>
            <div className="nav-links">
                {user ? (
                    <>
                        ...
                        <span className="text-muted" style={{ marginLeft: '1rem', borderLeft: '1px solid var(--border)', paddingLeft: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                            <User size={16} /> Welcome, {user.name}
                        </span>
